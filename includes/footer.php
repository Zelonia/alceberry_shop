<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				LCB Jakarta Barat.<br>
				
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">0823-456-789</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">arvissie@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2023 AlceBerry&trade;
			</div>

			<div class="developer">
				Dev by Titin Lestari Ningsih
			</div>

			<div class="designby">
				Design by Jessica Febriani P
			</div>
		</div>
	</div>
</footer>
